...
manga.get('/latest', cors(), function(req, res) {
    request('http://mangafox.me/releases', function(err, response, body) {
        ...
        for (var i = 0; i < links.length; i++) {
            ...
            list.push({
                manga_id: manga_id,
                cover: 'http://l.mfcdn.net/store/manga/'+ manga_id +'/cover.jpg?token=6b005f496d9e96d15343cd662940b99dbfde323c&ttl=1504360800&v=1504264142',
                name: name,
                link: link
            });
